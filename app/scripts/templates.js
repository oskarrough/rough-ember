...
function program3(depth0,data) {
  ...
  data.buffer.push("<p class=\"Template\">[_navigation]</p>\n");
...
function program1(depth0,data) {
  ...
  data.buffer.push("\n	</nav>\n\n	<div class=\"Area\">\n		<p class=\"Template\">[application/outlet]</p>\n		");
  stack1 = helpers._triageMustache.call(depth0, "outlet", {hash:{},hashTypes:{},hashContexts:{},contexts:[depth0],types:["ID"],data:data});
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  data.buffer.push("\n	</div>\n\n	<div class=\"Area\">\n		<p class=\"Template\">[application/modal]</p>\n		");
...
helpers = this.merge(helpers, Ember.Handlebars.helpers); data = data || {};
  ...
  data.buffer.push("<p class=\"Template\">[index]</p>\n<h1>");
...
function program1(depth0,data) {
  ...
  data.buffer.push("<p class=\"Template\">[modal]</p>\n<p>Modal dialog follows here:</p>\n");
...
helpers = this.merge(helpers, Ember.Handlebars.helpers); data = data || {};
  ...
  data.buffer.push("<p class=\"Template\">[page]</p>\n<h1>");
  data.buffer.push(escapeExpression(helpers.unbound.call(depth0, "title", {hash:{},hashTypes:{},hashContexts:{},contexts:[depth0],types:["ID"],data:data})));
  data.buffer.push("</h1>\n<div class=\"Body\">");
...
function program1(depth0,data) {
  ...
  data.buffer.push("<p class=\"Template\">[post]</p>\n<div class=\"modalshouldbehere\">\n");
  stack1 = (helper = helpers['modal-dialog'] || (depth0 && depth0['modal-dialog']),options={hash:{
    'action': ("close")
  },hashTypes:{'action': "STRING"},hashContexts:{'action': depth0},inverse:self.noop,fn:self.program(1, program1, data),contexts:[],types:[],data:data},helper ? helper.call(depth0, options) : helperMissing.call(depth0, "modal-dialog", options));
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
...
function program2(depth0,data) {
  ...
  data.buffer.push("<p class=\"Template\">[posts]</p>\n<p><button class='Button'\n         ");
  ...
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  data.buffer.push("\n</ul>\n\n<p class=\"Template\">[posts/modal]</p>\n");
  stack1 = helpers._triageMustache.call(depth0, "outlet", {hash:{},hashTypes:{},hashContexts:{},contexts:[depth0],types:["ID"],data:data});
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  data.buffer.push("\n");
  return buffer;
...
helpers = this.merge(helpers, Ember.Handlebars.helpers); data = data || {};
  ...
  data.buffer.push("<div class=\"Area\">\n	<p class=\"Template\">[components/modal-dialog]</p>\n	<div class=\"Overlay\" ");
  data.buffer.push(escapeExpression(helpers.action.call(depth0, "close", {hash:{},hashTypes:{},hashContexts:{},contexts:[depth0],types:["STRING"],data:data})));
  data.buffer.push(">\n		<div class=\"Modal\" ");
